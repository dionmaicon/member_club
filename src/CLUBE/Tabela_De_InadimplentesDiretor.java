 ...
 * @author jao
 */
public class Tabela_De_InadimplentesDiretor extends javax.swing.JFrame {
    private ArrayList<Socio> list = new ArrayList<>();
    private Socio socioF;
    /**
     * Creates new form Tabela_De_Socios
     */
    public Tabela_De_InadimplentesDiretor() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tabela_De_InadimplentesDiretor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tabela_De_InadimplentesDiretor().setVisible(true);
            }
        });
    }
    ...
    public void organizaTabela() {
        ...
        list = rnSocio.consultarInadimplentesMensalidade(true);
        if(list.isEmpty()){
