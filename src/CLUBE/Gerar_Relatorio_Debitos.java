 ...
 * @author jao
 */
public class Gerar_Relatorio_Debitos extends javax.swing.JFrame {
     ArrayList<Socio> list = new ArrayList<>();
    /**
     * Creates new form Gerar_Relatorio_Debitos
     */
    public Gerar_Relatorio_Debitos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Gerar Relatorio de Debitos Mensais");

        jLabel1.setText("Mes:");

        jLabel2.setText("Ano:");

        jLabel3.setText("Relatorio Mensal");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      rn.deletarTabelaInadimplentes();
      if (!tfAno.getText().equals("") && !tfMes.getText().equals("")){
          list.clear();
           list = rn.consultarInadimplentesMensalidade(Integer.parseInt(tfMes.getText()),Integer.parseInt(tfAno.getText()));
        for (Socio socio1 : list) {
            rn.inserirTabelaInadimplementes(socio1);
        }
      }
      list.clear();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gerar_Relatorio_Debitos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gerar_Relatorio_Debitos().setVisible(true);
            }
        });
    }
