...
public class Tabela_De_Socios_Final extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tabela_De_Socios_Final.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tabela_De_Socios_Final().setVisible(true);
            }
        });
    }
    ...
    public void organizaTabela() {
        ...
        list = rnSocio.consultarSociosAceitos();
        if(list.isEmpty()){
